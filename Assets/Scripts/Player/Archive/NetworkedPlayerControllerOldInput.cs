...
[CustomEditor(typeof(NetworkedPlayerControllerOldInput), true)]
public class NetworkedPlayerControllerOldInputEditor : NetworkTransformEditor
{
    ...
    {
        m_Speed = serializedObject.FindProperty(nameof(NetworkedPlayerControllerOldInput.Speed));
        m_ApplyVerticalInputToZAxis = serializedObject.FindProperty(nameof(NetworkedPlayerControllerOldInput.ApplyVerticalInputToZAxis));
        m_ObjectToCreate = serializedObject.FindProperty(nameof(NetworkedPlayerControllerOldInput.ObjectToCreate));
        base.OnEnable();
    }
    ...
    {
        var playerController = target as NetworkedPlayerControllerOldInput;
        void SetExpanded(bool expanded) { playerController.PlayerControllerPropertiesVisible = expanded; };
        DrawFoldOutGroup<NetworkedPlayerControllerOldInput>(playerController.GetType(), DisplayPlayerCubeControllerProperties, playerController.PlayerControllerPropertiesVisible, SetExpanded);
        base.OnInspectorGUI();
    }
}
#endif

public class NetworkedPlayerControllerOldInput : NetworkTransform
{
#if UNITY_EDITOR
